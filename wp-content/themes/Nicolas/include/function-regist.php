<?php
	...
	*/
	...
	if (function_exists('register_sidebar')){	
		...
		$sidebar_attr['before_title'] = '<div class="gdl-header-wrapper"><h3 class="gdl-header-title1">';
		$sidebar_attr['after_title'] = '</h3><div class="gdl-header-gimmick right"></div><div class="clear"></div></div>';
