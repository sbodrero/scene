...
if( is_object($EM_Event) && !$EM_Event->can_manage('edit_events','edit_others_events') ){
	?>
	<div class="wrap"><b><?php /* esc_html_e('Unauthorized Access','dbem'); */ ?> Veuillez <a href="http://www.desceneenscene.fr/enregistrez-vous/">vous inscrire</a> ou <a href="http://www.desceneenscene.fr/wp-admin/">vous connecter</b> pour proposer un événement</h2><p><?php /* echo sprintf(__('You do not have the rights to manage this %s.','dbem'),__('Event','dbem')); */ ?></p></div>
	<?php
	return false;
