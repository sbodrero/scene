...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
	<channel>
		...
		$args = array_merge(array('scope'=>get_option('dbem_rss_scope'), 'owner'=>false, 'limit'=>50, 'page'=>1, 'order'=>get_option('dbem_rss_order'), 'orderby'=>get_option('dbem_rss_orderby')), $args);
