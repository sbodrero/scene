...
/* POUR LES SORTIES */
function em_event_search_form2($args = array()){	$args = em_get_search_form_defaults($args);	$args['ajax'] = isset($args['ajax']) ? $args['ajax']:(!defined('EM_AJAX') || EM_AJAX );	em_locate_template('templates/events-search2.php',true, array('args'=>$args));}

/* POUR LES ATELIERS */
function em_event_search_form3($args = array()){	$args = em_get_search_form_defaults($args);	$args['ajax'] = isset($args['ajax']) ? $args['ajax']:(!defined('EM_AJAX') || EM_AJAX );	em_locate_template('templates/events-search3.php',true, array('args'=>$args));}

/* POUR LES STAGES */
function em_event_search_form4($args = array()){	$args = em_get_search_form_defaults($args);	$args['ajax'] = isset($args['ajax']) ? $args['ajax']:(!defined('EM_AJAX') || EM_AJAX );	em_locate_template('templates/events-search4.php',true, array('args'=>$args));}
...
/* POUR LES SORTIES */
function em_get_event_search_form2( $args = array() ){	ob_start();	em_event_search_form2($args);	return ob_get_clean();}

/* POUR LES ATELIERS */
function em_get_event_search_form3( $args = array() ){	ob_start();	em_event_search_form3($args);	return ob_get_clean();}

/* POUR LES STAGES */
function em_get_event_search_form4( $args = array() ){	ob_start();	em_event_search_form4($args);	return ob_get_clean();}
//Location Forms
/**
